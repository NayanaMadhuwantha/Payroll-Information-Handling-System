                ...
                <div class="col-md-12 d-flex">
                    <div class="card profile-box flex-fill">
                        <div class="card-body">
                            ...
                            <form action="{{ route('monthsalaryReport.get') }}" method="post">
                                @csrf
                            ...
                            <h3 class="page-title text-center mb-4 text-decoration-underline">Monthly Salary
                                Report
                                @isset($month_name)
                                    - {{ $month_name }}
                                @endisset
                                        ...
                                        @isset($salaries)
                                            @foreach($salaries as $salary)
                                                <tr>
                                                    ...
                                                    <td>{{ $salary->basic }}</td>
                                                    <td>{{ $salary->other_allowance + $salary->attendance_allowance }}</td>
                                                    <td>{{ $salary->no_pay + $salary->other_deductions + $salary->welfare + $salary->epf_8 }}</td>
