...
<div class="page-header">
    <div class="row align-items-center">
        <div class="col">
            <h3 class="page-title">Monthly Allowance Report</h3>
            <ul class="breadcrumb">
        ...
        <div class="card profile-box flex-fill">
            <div class="card-body">
                ...
                <form>
                    ...
                    <h3 class="page-title text-center mb-4 text-decoration-underline">Monthly Allowance Report</h3>
                            ...
                            <table class="table">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col">Allowance 01</th>
                                        <th scope="col">Allowance 02</th>
                                        <th scope="col">Allowance 03</th>
                                        <th scope="col">Allowance 04</th>
                                        <th scope="col">Total other Allowance</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
