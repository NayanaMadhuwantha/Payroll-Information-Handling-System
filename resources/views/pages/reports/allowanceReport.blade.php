            ...
            <div class="row">
                <div class="col-md-12 d-flex">
                    <div class="card profile-box flex-fill">
                        <div class="card-body">
                            <form action="{{ route('allowanceReport.get') }}" method="post">
                                @csrf
                            ...
                            <h3 class="page-title text-center mb-4 text-decoration-underline">Monthly Allowance
                                Report
                                @isset($month_name)
                                    - {{ $month_name }}
                                @endisset
                                        ...
                                        @isset($users)
                                            @foreach($users as $user)
                                                <tr>
                                                    ...
                                                    <td>{{ $user->attendance_allowances }}</td>
                                                    <td>{{ $user->other_allowances }}</td>
                                                    <td>{{ $user->total_allowances }}</td>
                                                </tr>
                                            @endforeach
                                        @endisset
                                        </tbody>
